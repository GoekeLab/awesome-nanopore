...
- [Nanom6A](https://github.com/kaifuchenlab/NanoNm with protocal from https://github.com/kaifuchenlab/STAR_Protocol) - [Python] - A Machine Learning Method to detect the 2'-O-methylation(Nm) in Nanopore direct RNA-seq 
